package com.silence.useradmin.infrastructure.interceptor.mybatis;
...
public class CryptInterceptor implements Interceptor {
     ...
     */
    private List<Object> listEncrypt(List<Object> plainList, CryptField cryptField) throws IllegalAccessException {
     ...
     * @throws IllegalAccessException
     */
    private List<Object> listDecrypt(List<Object> cipherList, CryptField cryptField) throws IllegalAccessException {
        ...
        for (Field field : objFields) {
            ...
            if (cryptField != null) {
                ...
                if (field.getType().equals(List.class)) {
                    field.set(plainObject, listEncrypt((List<Object>) plain, cryptField));
                    continue;
                }
